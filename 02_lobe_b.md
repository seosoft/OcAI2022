...
>
> Webカメラが接続されたPCでこちらのパートを演習することは可能です。  
...
1. このコンテンツには "data" フォルダーがあり、この中に演習で使用する画像ファイルがあります。  
   ...
   "data/Train" フォルダーで右クリックして [**エクスプローラーで表示する**] を選択します。
   
   <img src="./images/02/open_datafloder_from_vscode.jpg" width="300px" />

   <br />

   エクスプローラーで "data" フォルダーが表示されます。ここで "Train" フォルダーに移動します。
   ...
   また "None" フォルダーには手が写っていない画像が30枚あります。
...
3. インポートする画像があるフォルダーを選択します。  
   ...
   > "Paper", "Rock", "Scissors", "None" サブフォルダーを含むフォルダーを選択します。
